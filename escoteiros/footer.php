...
<div class="row"> </div>
          <div class="row">
            ...
            <div class="col-md-4 iten-rodape">
              <a href="<?php bloginfo('home'); ?>"><img src="<?php bloginfo('template_url'); ?>/images/escot.png" class="img-responsive" alt="Escoteiros IFRN" title="Escoteiros IFRN" style="margin-top: 30px; width: 350px;"</a>
           </div>
